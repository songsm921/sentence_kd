...
def process_gsm8k_dataset(output_file=None, math_difficulty_prompt=None, model_name=None, device="cuda", num_workers=None, debug_mode=False, debug_samples=8):
    ...
    if num_workers is None:
        if gpu_count > 0:
            num_workers = gpu_count  # Use exactly one process per GPU
    ...
    # Load the dataset
    print("Loading dataset: HuggingFaceH4/MATH-500")
    ...
    if output_file:
        ...
        final_path = "math500_with_difficulty"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_file",
        default="math500_with_difficulty",
